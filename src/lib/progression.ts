...
export const LEVEL_TITLES: Record<number, string> = {
  ...
  3: "Hechicero novato",
  4: "Guardián de runas",
  5: "Tejedor de hechizos",
  6: "Maestro de la torre",
  7: "Archimago joven",
  8: "Señor de la Academia",
  9: "Estrella arcana",
...
export const AVATAR_OPTIONS = {
  ...
  hat: [
    ...
    { id: "wizard" as const, label: "Sombrero de mago", emoji: "🧙", free: true, tag: "base" },
...
export const STORY_CHAPTERS: StoryChapter[] = [
  {
    ...
    text: "El aprendiz empuja las puertas de cristal estrellado. Un susurro dice: «Bienvenido, pequeño mago. Tus hechizos de verano despertarán la Academia Arcana.»",
    unlock: "level",
    value: 1,
  },
  {
    ...
    text: "En el patio de las chispas, una runa brilla bajo los pies del aprendiz. «Cada acierto enciende una estrella», canta el viento. El mapa de la Academia se hace más claro.",
    unlock: "level",
    value: 3,
  },
  {
    ...
    text: "Los espejos muestran al aprendiz un poco más alto, con capa al viento. «No eres solo puntos: eres historia en marcha», susurran. El familiar guiña un ojo.",
    unlock: "level",
    value: 5,
  },
  {
    ...
    text: "Desde lo alto, el aprendiz ve la ciudad lejana y el cielo de verano. La Academia confía un secreto: el conocimiento es la magia más fuerte de todas.",
    unlock: "level",
    value: 8,
  },
  {
  ...
  },
  {
    ...
    text: "La Bibliotecaria cierra un libro gigante. «Sujeto y predicado bailan en tus manos. La Biblioteca Misteriosa te nombra Maestro de las Oraciones.»",
    unlock: "boss",
    value: "language",
  },
  {
  ...
  },
  {
    ...
    text: "Tres soles se alinean sobre la Academia. Una llama suave se posa en el hombro del aprendiz: «La constancia es un hechizo que no se apaga.»",
    unlock: "streak",
    value: 3,
  },
  {
    ...
    text: "Siete estrellas caen en el cuaderno del aprendiz. «Una semana de magia diaria», canta el coro. El verano se siente más brillante.",
    unlock: "streak",
    value: 7,
  },
  {
    ...
    text: "A mitad de la Torre de Números, los escalones cantan. El aprendiz ya no teme a las restas largas: cada paso suena a victoria.",
    unlock: "zone",
    value: "math-half",
  },
  {
    ...
    text: "Las oraciones del pasillo se ordenan solas. «Quién hace qué», repite el aprendiz, y las páginas se abren como alas.",
    unlock: "zone",
    value: "lang-half",
  },
];
...
> = {
  ...
  "level-5": {
    name: "Tejedor de Hechizos",
    desc: "Alcanzaste el nivel 5 de mago",
    emoji: "🧵",
    glow: "violet",
  },
  "level-10": {
